...
public class CartScreenHandler extends BaseScreenHandler {
	...
	public void requestToPlaceRushOrder() throws SQLException, IOException {
		try {
			LOGGER.info("Handle place rush order");
			// create placeOrderController and process the order
			...
			if (placeRushOrderController.isSupportRush()) {
				LOGGER.info("Support rush");
			} else {
				LOGGER.info("Not support rush");
				PopupScreen.error("No items support rush delivery, please choose PLACE ORDER");
				return;
			}
