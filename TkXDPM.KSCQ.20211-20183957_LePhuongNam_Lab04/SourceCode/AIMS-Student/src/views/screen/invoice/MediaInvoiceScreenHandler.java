...
public class MediaInvoiceScreenHandler extends FXMLScreenHandler{
    ...
    public void setOrderMedia(OrderMedia orderMedia, boolean isRushOrder) throws SQLException{
    ...
    public void setMediaInfo() throws SQLException{
        ...
        instruction.setText("Giao hang thường");
        if (this.isRushOrder) {
        	if (orderMedia.getMedia().isSupportRush()) {
        		instruction.setText("Giao hang nhanh");
        	}
        }
