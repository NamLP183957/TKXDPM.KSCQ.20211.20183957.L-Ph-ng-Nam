...
public class InvoiceScreenHandler extends BaseScreenHandler {
	...
	public InvoiceScreenHandler(Stage stage, String screenPath, Invoice invoice, boolean isRushOrder) throws IOException {
	...
	private void setInvoiceInfo(){
		...
		//LOGGER.info(getBController().getClass().getName());
		invoice.getOrder().getlstOrderMedia().forEach(orderMedia -> {
			try {
				...
				if (isRushOrder) {
					mis.setOrderMedia((OrderMedia) orderMedia, true);
				} else {
					mis.setOrderMedia((OrderMedia) orderMedia, false);
				}
